...
class AddFrutas extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 80.0, start: 43.0),
            Pin(size: 29.0, middle: 0.6678),
            child: const Text(
              'Precio',
              style: TextStyle(
                fontFamily: 'Arial Rounded MT',
          ...
          Pinned.fromPins(
            Pin(size: 231.0, start: 32.0),
            Pin(size: 42.0, middle: 0.7183),
            child: Stack(
              children: <Widget>[
                Container(
          ...
          Align(
            alignment: const Alignment(0.154, 0.43),
            child: SizedBox(
              width: 12.0,
              height: 28.0,
              child: Stack(
          ...
          Align(
            alignment: const Alignment(0.081, 0.437),
            child: SizedBox(
              width: 1.0,
              height: 42.0,
              child: SvgPicture.string(
          ...
          const Align(
            alignment: Alignment(0.617, -0.36),
            child: SizedBox(
              width: 78.0,
              height: 29.0,
              child: Text(
          ...
          Align(
            alignment: const Alignment(0.081, 0.64),
            child: SizedBox(
              width: 1.0,
              height: 42.0,
              child: SvgPicture.string(
          ...
          Align(
            alignment: const Alignment(0.158, 0.629),
            child: SizedBox(
              width: 22.0,
              height: 26.0,
              child: Stack(
...
const String _svg_eba24y =
    '<svg viewBox="230.8 635.0 1.0 42.0" ><path transform="translate(-2960.0, 507.0)" d="M 3190.830810546875 127.9999923706055 L 3190.830810546875 170" fill="none" stroke="#707070" stroke-width="2" stroke-opacity="0.22" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_emt5cz =
    '<svg viewBox="230.8 725.0 1.0 42.0" ><path transform="translate(-2960.0, 597.0)" d="M 3190.830810546875 127.9999923706055 L 3190.830810546875 170" fill="none" stroke="#707070" stroke-width="2" stroke-opacity="0.22" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
