...
class AddHyL extends StatelessWidget {
  const AddHyL({Key? key}) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: const Alignment(0.13, 0.43),
            child: SizedBox(
              width: 12.0,
              height: 28.0,
              child: Stack(
          ...
          Align(
            alignment: const Alignment(0.062, 0.437),
            child: SizedBox(
              width: 1.0,
              height: 42.0,
              child: SvgPicture.string(
          ...
          Pinned.fromPins(
            Pin(size: 117.0, end: 33.0),
            Pin(size: 58.0, middle: 0.3134),
            child: const Text(
              'Huevos y \nLácteos',
              style: TextStyle(
                fontFamily: 'Arial Rounded MT',
          ...
          Align(
            alignment: const Alignment(0.062, 0.652),
            child: SizedBox(
              width: 1.0,
              height: 42.0,
              child: SvgPicture.string(
          ...
          Align(
            alignment: const Alignment(0.133, 0.64),
            child: SizedBox(
              width: 22.0,
              height: 26.0,
              child: Stack(
...
const String _svg_u8vrz7 =
    '<svg viewBox="226.8 635.0 1.0 42.0" ><path transform="translate(-2964.0, 507.0)" d="M 3190.830810546875 127.9999923706055 L 3190.830810546875 170" fill="none" stroke="#707070" stroke-width="2" stroke-opacity="0.22" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_km9bvn =
    '<svg viewBox="226.8 730.0 1.0 42.0" ><path transform="translate(-2964.0, 602.0)" d="M 3190.830810546875 127.9999923706055 L 3190.830810546875 170" fill="none" stroke="#707070" stroke-width="2" stroke-opacity="0.22" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
